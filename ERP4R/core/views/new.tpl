...
*/
        ...
        hr{
          margin: -0.75rem 0 0.588rem !important;
        }
    ...
    <nav class="top-bar" data-topbar role="navigation">
      ...
      <section class="top-bar-section">
        <ul class="right" style="margin-right:50px;">
          ...
          <li><a href="#" onclick="window.open('https://compraspublicas.mfpapps.tk/login','_blank');" >Entrar</a></li>
          <!--
      ...
      <div class="twelve columns header_nav">
        <div class="row">      
          <ul id="menu-header" class="nav-bar horizontal">             
            ...
            <li class="active"><a href="new">Contratos</a></li>      
            <li class="has-flyout">
             <a href="#" data-options="align:left" data-dropdown="drop">Legislação</a><a href="#" class="flyout-toggle"></a>
              <ul id="drop" class="flyout"><!-- Flyout Menu -->
                <li class="has-flyout"><a href="Leis">Leis</a></li>
                <li class="has-flyout"><a href="Decretos">Decretos</a></li>
                <li class="has-flyout"><a href="Resolucoes&Portarias">Resoluções e Portarias</a></li>
                <li class="has-flyout"><a href="Regulamentos">Regulamentos</a></li>
              </ul> 
            </li><!-- END Flyout Menu -->
      ...
      <div class="large-12 columns">
        <div class="row">     
          ...
          <div class="large-3 columns ">
            <div class="panel">
              <h5><a href="#">Categoria documento</a></h5>
              <div class="section-container vertical-nav" data-section data-options="deep_linking: false; one_up: true">
                <section class="section">
                  <h5 class="title"><a href="#">Categoria 1</a></h5>
                </section>
                <section class="section">
                  <h5 class="title"><a href="#">Categoria 2</a></h5>
                </section>
                <section class="section">
                  <h5 class="title"><a href="#">Categoria 3</a></h5>
                </section>
                <section class="section">
                  <h5 class="title"><a href="#">Categoria 4</a></h5>
                </section>
                <section class="section">
                  <h5 class="title"><a href="#">Categoria 5</a></h5>
                </section>
                <section class="section">
                  <h5 class="title"><a href="#">Categoria 6</a></h5>
                </section>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="large-1 columns small-3"><img src="/static/images/PdfLogo.jpg"/></div>
              <div class="large-11 columns">
                <p><strong>Titulo do documento:</strong> Texto descrevendo o conteúdo do documento! Aqui o interessado visualizará todos os contratos de despesa assinados pelo estado.</p>
                <ul class="inline-list">
                  <li><a href="view_new"><i class="fi-eye"></i> ver mais</a></li>
                </ul>
              </div>
          </div>
          ...
          <div class="row">
            <div class="large-1 columns small-3"><img src="/static/images/WordLogo.png"/></div>
            <div class="large-11 columns">
              <p><strong>Titulo do documento:</strong> Texto descrevendo o conteúdo do documento! Aqui o interessado visualizará todos os contratos de despesa assinados pelo estado.</p>
              <ul class="inline-list">
                <li><a href="view_new"><i class="fi-eye"></i> ver mais</a></li>
          ...
          <div class="row">
            <div class="large-1 columns small-3"><img src="/static/images/ExcelLogo.png"/></div>
            <div class="large-11 columns">
              <p><strong>Titulo do documento:</strong> Texto descrevendo o conteúdo do documento! Aqui o interessado visualizará todos os contratos de despesa assinados pelo estado.</p>
              <ul class="inline-list">
                <li><a href="view_new"><i class="fi-eye"></i> ver mais</a></li>
