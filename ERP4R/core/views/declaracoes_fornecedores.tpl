...
<html class="no-js" lang="en" data-useragent="Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; Trident/6.0)">
  ...
  <body> 
      ...
      <div class="large-12 columns">
        <div class="row">   
          <ul class="breadcrumbs">
            ...
            <li class="current"><a href="#">Declarações dos Fornecedores</a></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="large-12 columns">
        <div class="row">  
          <h3><img src="/static/images/paste.png"/> Declarações dos Fornecedores</h3>
          <div class="panel callout radius">
            <h6>{{len(dadosDeclaracoesFornecedores)}}&nbsp; Documentos disponível</h6>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="large-12 columns">
        <div class="row">  
          ...
          % for dDirectiva in dadosDeclaracoesFornecedores:
            <div class="row">
            <div class="large-1 columns small-3">
                   
                             
              %   if(dDirectiva['tipo'] == "Pdf"):     
                <img src="/static/images/PdfLogo.jpg"/>
              %   end
              %   if(dDirectiva['tipo'] == "Word"):     
                <img src="/static/images/WordLogo.png"/>
              %   end
              %   if (dDirectiva['tipo'] == "Excel"):     
                <img src="/static/images/ExcelLogo.png"/>
              %   end
          
            </div>
            <div class="large-11 columns">
              <p><strong>{{dDirectiva['nome']}}</strong><br /> {{dDirectiva['obs']}}</p>
              <ul class="inline-list">
                <li>
                  <a href="{{dDirectiva['documeanexo']}}" onclick="openPdf(event, '{{dDirectiva['documeanexo']}}', 'newpage.html');" style="background: none !important;">
