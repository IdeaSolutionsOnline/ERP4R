...
<html class="no-js" lang="en" data-useragent="Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; Trident/6.0)">
  ...
  <body> 
      ...
      <div class="large-12 columns">
        <div class="row">   
          <ul class="breadcrumbs">
            ...
            <li class="current"><a href="#">Directivas</a></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="large-12 columns">
        <div class="row">  
          <h3><img src="/static/images/paste.png"/> Directivas</h3>
          <div class="panel callout radius">
            <h6>{{len(dadosDocDirectiva)}}&nbsp; Documentos disponível</h6>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="large-12 columns">
        <div class="row">  
          ...
          % for dDirectiva in dadosDocDirectiva:
            <div class="row">
