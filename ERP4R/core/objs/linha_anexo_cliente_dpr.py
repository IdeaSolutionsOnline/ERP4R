...
__model_name__ = 'linha_anexo_cliente_dpr.LinhaAnexoClienteDPR'
import auth, base_models
from orm import *
from form import *

class LinhaAnexoClienteDPR(Model, View):
    def __init__(self, **kargs):
        Model.__init__(self, **kargs)
        self.__name__ = 'linha_anexo_cliente_dpr'
        ...
        self.anexo_cliente_dpr = parent_field(view_order = 13, name = 'Anexo Cliente DPR', hidden=True, model_name = 'anexo_cliente_dpr.AnexoClienteDPR',nolabel=True, onlist = False, column = 'id')
