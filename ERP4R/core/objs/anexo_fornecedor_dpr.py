...
__model_name__ = 'anexo_fornecedor_dpr.AnexoFornecedorDPR'
...
class AnexoFornecedorDPR(Model, View):
    ...
    def __init__(self, **kargs):
        ...
        self.linha_anexo_fornecedor_dpr = list_field(view_order =8, name = 'Linhas de Anexo', condition = "anexo_fornecedor_dpr='{id}'", column='designacao', model_name = 'linha_anexo_fornecedor_dpr.LinhaAnexoFornecedorDPR', list_edit_mode = 'inline', onlist = False)
