...
__model_name__ = 'rh_outros_rendimentos_funcionario.RHOutrosRendimentosFuncionario'
...
class RHOutrosRendimentosFuncionario(Model, View):
    def __init__(self, **kargs):
        Model.__init__(self, **kargs)
        self.__name__ = 'rh_outros_rendimentos_funcionario'
        self.__title__= 'Outros Rendimento de Funcionarios'
        ...
        self.rh_folha_salario = parent_field(view_order=4 , name='Salario', size=70,onlist=False, model_name ='rh_folha_salario.RHFolhaSalario', column ='periodo', hidden =True)
