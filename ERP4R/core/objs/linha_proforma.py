...
__model_name__ = 'linha_proforma.LinhaProforma'
...
class LinhaProforma(Model, View):
    def __init__(self, **kargs):
        Model.__init__(self, **kargs)
        self.__name__ = 'linha_proforma'
        self.__title__ = 'Linhas de Factura Proforma'
        ...
        self.proforma = parent_field(view_order=1, name ='Factura Proforma', args='style:visibility="hidden"', model_name='proforma.Proforma', nolabel=True, onlist=False, column='numero')
        ...
        self.unidade = combo_field(view_order=5, name ='Unidade', size=30, args='required tabIndex="-1"', onchange='produto_onchange', model='unidade', column='nome', options="model.get_opts('Unidade','()')")
