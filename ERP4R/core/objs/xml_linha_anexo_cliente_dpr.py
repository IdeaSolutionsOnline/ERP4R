...
__model_name__ = 'xml_linha_anexo_cliente_dpr.XMLLinhaAnexoClienteDPR'
import auth, base_models
from orm import *
from form import *

class XMLLinhaAnexoClienteDPR(Model, View):
    def __init__(self, **kargs):
        Model.__init__(self, **kargs)
        self.__name__ = 'xml_linha_anexo_cliente_dpr'
        ...
        self.xml_anexo_cliente_dpr = parent_field(view_order = 13, name = 'Anexo Cliente DPR', hidden=True, model_name = 'xml_anexo_cliente_dpr.XMLAnexoClienteDPR',nolabel=True, onlist = False, column = 'id')
