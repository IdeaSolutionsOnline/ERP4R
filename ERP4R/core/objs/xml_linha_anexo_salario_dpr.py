...
__model_name__ = 'xml_linha_anexo_salario_dpr.XMLLinhaAnexoSalarioDPR'
import auth, base_models
from orm import *
from form import *
from terceiro import Terceiro

class XMLLinhaAnexoSalarioDPR(Model, View):
    def __init__(self, **kargs):
        Model.__init__(self, **kargs)
        self.__name__ = 'xml_linha_anexo_salario_dpr'
        ...
        self.xml_anexo_salario_dpr = parent_field(view_order = 15, name = 'Anexo Salário DPR', hidden=True, model_name = 'xml_anexo_salario_dpr.XMLAnexoSalarioDPR',nolabel=True, onlist = False, column = 'id')
