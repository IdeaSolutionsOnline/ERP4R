...
__model_name__ = 'xml_linha_anexo_cliente_m106.XMLLinhaAnexoClienteM106'
import auth, base_models
from orm import *
from form import *

class XMLLinhaAnexoClienteM106(Model, View):
    def __init__(self, **kargs):
        Model.__init__(self, **kargs)
        self.__name__ = 'xml_linha_anexo_cliente_m106'
        ...
        self.xml_anexo_cliente_m106 = parent_field(view_order = 15, name = 'Anexo Cliente', hidden=True, model_name = 'xml_anexo_cliente_m106.XMLAnexoClienteM106',nolabel=True, onlist = False, column = 'id')