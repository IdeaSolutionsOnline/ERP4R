...
__model_name__ = 'aquisicoes.Aquisicoes'
import auth, base_models
from orm import *
from form import *

class Aquisicoes(Model, View):
    def __init__(self, **kargs):
        Model.__init__(self, **kargs)
        self.__name__ = 'aquisicoes'
        self.__title__ ='Aquisicoes' #Gestão de atendimento Presencial serviço
        self.__model_name__ = __model_name__
        self.__get_options__ = ['nome']
        self.__list_edit_mode__ = 'edit'
        #self.__order_by__ = 'aquisicoes.nome'
        self.__auth__ = {
            'read':['All'],
            'write':['Atendedor'],
