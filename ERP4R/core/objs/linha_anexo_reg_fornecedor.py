...
__model_name__ = 'linha_anexo_reg_fornecedor.LinhaAnexoRegFornecedor'
...
class LinhaAnexoRegFornecedor(Model, View):
    def __init__(self, **kargs):
        ...
        self.__name__ = 'linha_anexo_reg_fornecedor'
        ...
        self.anexo_reg_fornecedor = parent_field(view_order = 19, name = 'Anexo Reg Fornecedor', hidden=True, model_name = 'anexo_reg_fornecedor.AnexoRegFornecedor',nolabel=True, onlist = False)
