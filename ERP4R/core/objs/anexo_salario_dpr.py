...
__model_name__ = 'anexo_salario_dpr.AnexoSalarioDPR'
...
class AnexoSalarioDPR(Model, View):
    ...
    def __init__(self, **kargs):
        ...
        self.linha_anexo_salario_dpr = list_field(view_order =8, name = 'Linhas de Anexo', condition = "anexo_salario_dpr='{id}'", column='designacao', model_name = 'linha_anexo_salario_dpr.LinhaAnexoSalarioDPR', list_edit_mode = 'inline', onlist = False)
        ...
        self.modelo_dpr = parent_field(view_order = 17, name = 'Modelo DPR', hidden=True, model_name = 'modelo_dpr.ModeloDPR',nolabel=True, onlist = False, column = 'id')
    ...
    def record_lines(self, key):
        def get_results():
            try:
                from my_linha_anexo_salario_dpr import LinhaAnexoSalarioDPR
            except:
                from linha_anexo_salario_dpr import LinhaAnexoSalarioDPR
            record_lines = LinhaAnexoSalarioDPR(where="anexo_salario_dpr = '{id}'".format(id=key)).get()
            return record_lines
