      ...
      <div class="twelve columns header_nav">
        <div class="row">      
          <ul id="menu-header" class="nav-bar horizontal">             
            ...
            <li class="active"><a href="lk">Entidade pública</a></li>
...
<br>
<div class="row">
% #for d in dadosadjudic:
<div class="medium-3 large-3 text-center columns">
<img src="/static/images/logo_minfin.png">
<h4>Nome da entidade</h4>
<p>Pequeno texto descrevendo a entidade! E outras informações que julgarem primordial.</p>
</div>
% #end
