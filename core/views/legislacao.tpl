...
<html class="no-js" lang="en" data-useragent="Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; Trident/6.0)">
  ...
  <body> 
      ...
      <div class="large-12 columns">
        <div class="row">   
          <ul class="breadcrumbs">
            ...
            <li class="unavailable"><a href="#">Legislação</a></li>
            <!--<li class="current"><a href="#">Leis</a></li>-->
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="large-12 columns">
        <div class="row">  
          <h3><img src="/static/images/paste.png"/> Legislação</h3>
          <div class="panel callout radius">
            <h6>{{len(dadosDocLeis)}}&nbsp; Documentos disponível</h6>                    
          </div>                     
        </div>
      </div>         
    </div>
        ...
        <div class="row"> 
          % for dlies in dadosDocLeis:
            ...
            <div class="large-11 columns">              
              <p>
                <span><strong>{{dlies['nome']}} &nbsp;&nbsp;</strong></span> - <span>&nbsp;&nbsp; {{dlies['referencia']}} &nbsp;&nbsp;</span>
              </p>
              <p>{{dlies['obs']}}</p>
              <ul class="inline-list">
                <li>
                  <a href="{{dlies['documeanexo']}}" onclick="openPdf(event, '{{dlies['documeanexo']}}', 'newpage.html');" style="background: none !important;">
  ...
  <!-- 
    ...
    <div class="row">
      <div class="large-12 columns">
        <div class="row">  
          <h3><img src="/static/images/paste.png"/> Decretos Leis</h3>
          <div class="panel callout radius">
            <h6>{{len(dadosDocDecretos)}}&nbsp; Documentos disponível</h6>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="large-12 columns">
        <div class="row">  
          ...
          % for dDecretos in dadosDocDecretos:
            <div class="row">
            <div class="large-1 columns small-3">
                   
                             
              %   if(dDecretos['tipo'] == "Pdf"):     
                <img src="/static/images/PdfLogo.jpg"/>
              %   end
              %   if(dDecretos['tipo'] == "Word"):     
                <img src="/static/images/WordLogo.png"/>
              %   end
              %   if (dDecretos['tipo'] == "Excel"):     
                <img src="/static/images/ExcelLogo.png"/>
              %   end
          
            </div>
            <div class="large-11 columns">
              <p><strong>{{dDecretos['nome']}}</strong><br /> {{dDecretos['obs']}}</p>
              <ul class="inline-list">
                <li>
                  <a href="{{dDecretos['documeanexo']}}" onclick="openPdf(event, '{{dDecretos['documeanexo']}}', 'newpage.html');" style="background: none !important;">
                    <i class="fi-eye"></i> ver mais
                  </a>
                </li>
              </ul>
    ...
    <div class="row">
      <div class="large-12 columns">
        <div class="row">  
          <h3><img src="/static/images/paste.png"/> Resoluções e Portarias</h3>
          <div class="panel callout radius">
            <h6>{{len(dadosDocResolucoesPortarias)}}&nbsp; Documentos disponível</h6>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="large-12 columns">
        <div class="row">    
          % for dResolucoesPortarias in dadosDocResolucoesPortarias:
            <div class="row">
            <div class="large-1 columns small-3">
                   
              %   if(dResolucoesPortarias['tipo'] == "Pdf"):     
              <img src="/static/images/PdfLogo.jpg"/>
              %   end
              %   if(dResolucoesPortarias['tipo'] == "Word"):     
              <img src="/static/images/WordLogo.png"/>
              %   end
              %   if (dResolucoesPortarias['tipo'] == "Excel"):     
              <img src="/static/images/ExcelLogo.png"/>
              %   end
          
            </div>
            <div class="large-11 columns">
              <p><strong>{{dResolucoesPortarias['nome']}}</strong><br />{{dResolucoesPortarias['obs']}}</p>
              <ul class="inline-list">
                <li>
                  <a href="{{dResolucoesPortarias['documeanexo']}}" onclick="openPdf(event, '{{dResolucoesPortarias['documeanexo']}}', 'newpage.html');" style="background: none !important;">
                    <i class="fi-eye"></i> ver mais
                  </a>
                </li>
              </ul>
    ...
    <div class="row">
      <div class="large-12 columns">
        <div class="row">  
          <h3><img src="/static/images/paste.png"/> Regulamentos</h3>
          <div class="panel callout radius">
            <h6>{{len(dadosDocRegulamentos)}}&nbsp; Documentos disponível</h6>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="large-12 columns">
        <div class="row">    
          % for dregulamentos in dadosDocRegulamentos:
            <div class="row">
            <div class="large-1 columns small-3">
                   
              
              %   if(dregulamentos['tipo'] == "Pdf"):     
              <img src="/static/images/PdfLogo.jpg"/>
              %   end
              %   if(dregulamentos['tipo'] == "Word"):     
              <img src="/static/images/WordLogo.png"/>
              %   end
              %   if (dregulamentos['tipo'] == "Excel"):     
              <img src="/static/images/ExcelLogo.png"/>
              %   end
          
            </div>
            <div class="large-11 columns">
              <p><strong>{{dregulamentos['nome']}}</strong><br />{{dregulamentos['obs']}}</p>
              <ul class="inline-list">
                <li>
                  <a href="{{dregulamentos['documeanexo']}}" onclick="openPdf(event, '{{dregulamentos['documeanexo']}}', 'newpage.html');" style="background: none !important;">
                    <i class="fi-eye"></i> ver mais
                  </a>
                </li>
              </ul>
