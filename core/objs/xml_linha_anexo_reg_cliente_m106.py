...
__model_name__ = 'xml_linha_anexo_reg_cliente_m106.XMLLinhaAnexoRegClienteM106'
import auth, base_models
from orm import *
from form import *


class XMLLinhaAnexoRegClienteM106(Model, View):
    def __init__(self, **kargs):
        Model.__init__(self, **kargs)
        self.__name__ = 'xml_linha_anexo_reg_cliente_m106'
        ...
        self.xml_anexo_reg_cliente_m106 = parent_field(view_order = 4, name = 'Anexo Reg Cliente', hidden=True, model_name = 'xml_anexo_reg_cliente_m106.XMLAnexoRegClienteM106',nolabel=True, onlist = False)
