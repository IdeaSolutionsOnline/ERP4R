...
__model_name__ = 'xml_anexo_cliente_dpr.XMLAnexoClienteDPR'
...
class XMLAnexoClienteDPR(Model, View):
    ...
    def __init__(self, **kargs):
        ...
        self.xml_linha_anexo_cliente_dpr = list_field(view_order =8, name = 'Linhas de Anexo', condition = "xml_anexo_cliente_dpr='{id}'", column='designacao', model_name = 'xml_linha_anexo_cliente_dpr.XMLLinhaAnexoClienteDPR', list_edit_mode = 'inline', onlist = False)
    ...
    def record_lines(self, key):
        def get_results():
            try:
                ...
                from xml_linha_anexo_cliente_dpr import XMLLinhaAnexoClienteDPR
            record_lines = XMLLinhaAnexoClienteDPR(where="xml_anexo_cliente_dpr = '{id}'".format(id=key)).get()
            return record_lines
