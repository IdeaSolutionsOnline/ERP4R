...
__model_name__ = 'anexo_reg_fornecedor.AnexoRegFornecedor'
import auth, base_models
from orm import *
from form import *


class AnexoRegFornecedor(Model, View):
    def __init__(self, **kargs):
        #depois por aqui entre datas e só de um diario ou periodo, etc, etc.
        Model.__init__(self, **kargs)
        self.__name__ = 'anexo_reg_fornecedor'
        ...
        # linhas do anexo
        self.linha_anexo_reg_fornecedor = list_field(view_order = 8, name = 'Linhas', condition = "anexo_reg_fornecedor='{id}'", model_name = 'linha_anexo_reg_fornecedor.LinhaAnexoRegFornecedor', list_edit_mode = 'inline', onlist = False)
