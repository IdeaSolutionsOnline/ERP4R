...
__model_name__ = 'linha_anexo_fornecedor.LinhaAnexoFornecedor'
import auth, base_models
from orm import *
from form import *


class LinhaAnexoFornecedor(Model, View):
    def __init__(self, **kargs):
        Model.__init__(self, **kargs)
        self.__name__ = 'linha_anexo_fornecedor'
        ...
        self.anexo_fornecedor = parent_field(view_order = 15, name = 'Anexo Fornecedor', hidden=True, model_name = 'anexo_fornecedor.AnexoFornecedor',nolabel=True, onlist = False)
