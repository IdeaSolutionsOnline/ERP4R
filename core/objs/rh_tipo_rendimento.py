...
__model_name__ = 'rh_tipo_rendimento.RHTipoRendimento'
...
class RHTipoRendimento(Model, View):
    def __init__(self, **kargs):
        Model.__init__(self, **kargs)
        self.__name__ = 'rh_tipo_rendimento'
        ...
        self.desconto_inps = boolean_field(view_order=3, name='Incluir na Segurança Social?', size=90, default=True)
