...
__model_name__ = 'xml_linha_anexo_fornecedor_dpr.XMLLinhaAnexoFornecedorDPR'
import auth, base_models
from orm import *
from form import *

class XMLLinhaAnexoFornecedorDPR(Model, View):
    def __init__(self, **kargs):
        Model.__init__(self, **kargs)
        self.__name__ = 'xml_linha_anexo_fornecedor_dpr'
        ...
        self.xml_anexo_fornecedor_dpr = parent_field(view_order = 13, name = 'Anexo Fornecedor DPR', hidden=True, model_name = 'xml_anexo_fornecedor_dpr.XMLAnexoFornecedorDPR',nolabel=True, onlist = False, column = 'id')
