...
__model_name__ = 'xml_anexo_reg_cliente_m106.XMLAnexoRegClienteM106'
import auth, base_models
from orm import *
from form import *


class XMLAnexoRegClienteM106(Model, View):
    def __init__(self, **kargs):
        #depois por aqui entre datas e só de um diario ou periodo, etc, etc.
        Model.__init__(self, **kargs)
        self.__name__ = 'xml_anexo_reg_cliente_m106'
        ...
        # linhas do anexo
        self.xml_linha_anexo_reg_cliente_m106 = list_field(view_order = 8, name = 'Linhas', condition = "xml_anexo_reg_cliente_m106='{id}'", model_name = 'xml_linha_anexo_reg_cliente_m106.XMLLinhaAnexoRegClienteM106', list_edit_mode = 'inline', onlist = False)
